#!/bin/bash
#Generate analysis script for every sample. The fastq files are generated from bam files in script "". Script content was written by my colleague Du Xiaohong.
for i in $(ls )
do
    echo "#!/bin/bash
